paintings =  [
  ...
  },
  {
    ...
    "slug":
      "jacob-cornelisz-van-oostsanen-deploration-and-entombment-of-christ",
  ...
  },
  {
    ...
    "slug":
      "rembrandt-van-rijn-self-portrait-with-plumed-cap-and-lowered-sabre",
  ...
  },
  {
    ...
    "slug":
      "rembrandt-van-rijn-christ-and-the-woman-of-samaria-among-ruins-1",
  ...
  },
  {
    ...
    "slug":
      "joris-hoefnagel-animalia-qvadrvpedia-et-reptilia-terra-plate-liii",
...
paintings.each do |pntg|
  artist_data = pntg[:artist]
  artist = Artist.find_or_create_by(artist_data)
  museum_name = pntg[:collecting_institution] || 'Unknown Museum'
  artist.paintings.create(
    title: pntg[:title],
    slug: pntg[:slug],
    date: pntg[:date],
    image: pntg[:image],
    width: pntg[:dimensions][:width],
    height: pntg[:dimensions][:height],
    votes: rand(60),
